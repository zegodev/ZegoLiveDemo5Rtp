...
extern "C" {
    ...
    /**
     ...
     @return 参考 enum ZegoErrorCode
     */
    ZEGOAVKIT_API int zego_audio_frame_set_capture_config(struct ZegoAudioFrame* audio_frame, int channels, int sample_rate);
     ...
     */
    ZEGOAVKIT_API int zego_audio_frame_set_captured_data(struct ZegoAudioFrame* audio_frame, int samples, unsigned char* data);
