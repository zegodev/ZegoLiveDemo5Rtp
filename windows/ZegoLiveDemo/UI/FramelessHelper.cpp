...
public:
	...
	void setNeedDoubleClick(bool isDoubleClick);
private:
    // 更新鼠标样式
...
private:
    ...
    bool m_bMax;
	bool m_isNeedDoubleClick = false;
    QRect m_rect;
...
void WidgetData::setNeedDoubleClick(bool isDoubleClick)
{
	m_isNeedDoubleClick = isDoubleClick;
}
...
void FramelessHelper::setTitleDoubleClick(QWidget *w, bool isDoubleClick)
{
	WidgetData *data = d->m_widgetDataHash[w];
	if (!data)
		return;

	data->setNeedDoubleClick(isDoubleClick);
}
